      ...
      return {
        ...
        data: {
          ...
          metrics: {
            ...
            droppedRequests: snap.droppedRequests ?? 0,
            cacheHitRatio: snap.cacheHitRatio ?? 0,
            connectionPoolMax: snap.connectionPoolMax ?? 100,
            coldStartMs: snap.coldStartMs ?? 0,
            diskIOPSMax: snap.diskIOPSMax ?? 0,
            isPrimaryDB: snap.isPrimaryDB ?? false,
            activeConnections: snap.activeConnections ?? 0,
            desiredInstances: snap.desiredInstances ?? 0,
            scalingEvent: snap.scalingEvent ?? "",

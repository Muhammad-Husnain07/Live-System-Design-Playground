      ...
      {nodeId && node && meta && (
        <motion.div
          ...
          style={{
            ...
            zIndex: spatialTokens.z.deepDive,
            width: 560,
            maxHeight: "80vh",
        ...
        >
          ...
          >
            ...
            <Box sx={{ flex: 1, minWidth: 0 }}>
              <Typography sx={{ fontSize: "0.8rem", fontWeight: 600, color: "#EDEDEF", fontFamily: spatialTokens.font.ui }}>
                {node.data?.label ?? meta.label}
              </Typography>
              <Typography sx={{ fontSize: "0.6rem", color: "rgba(255,255,255,0.35)", fontFamily: spatialTokens.font.mono }}>
    ...
    <Box>
      <Box sx={{ display: "flex", alignItems: "center", justifyContent: "space-between", mb: 0.75 }}>
        <Box sx={{ display: "flex", alignItems: "center", gap: 0.5 }}>
          ...
          <Typography sx={{ fontSize: "0.6rem", fontWeight: 600, color: "rgba(255,255,255,0.5)", textTransform: "uppercase", letterSpacing: "0.06em", fontFamily: spatialTokens.font.ui }}>
            {title}
          </Typography>
        </Box>
